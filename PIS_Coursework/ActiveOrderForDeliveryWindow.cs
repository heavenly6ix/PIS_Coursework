...
{
    public partial class ActiveOrderForDeliveryWindow : Form
    {
        private readonly FacadeDatabase _facade;
        public CourierMainWindow _courierMainWindow;
        public ActiveOrderForDeliveryWindow(FacadeDatabase facade, CourierMainWindow courierMainWindow)
        {
            InitializeComponent();
            _facade = facade;
        ...
        private void ActiveOrderForDeliveryWindow_Load(object sender, EventArgs e)
        {
            ConfigureDataGridView();
            var orders = _facade.GetOrdersForDelivery();
        ...
        private void buttonShowOrder_Click(object sender, EventArgs e)
        {
            ...
            var infoOrderWindow = new InfoOrderWindow(_facade, selectedIdOrder, selectedDate, selectedAdress);
            this.Hide();
        ...
        private void buttonTakeOrder_Click(object sender, EventArgs e)
        {
            ...
            DataGridViewRow selectedRow = dataGridViewOrders.SelectedRows[0];
            int selectedIdOrder = Convert.ToInt32(selectedRow.Cells[columnName: "IdOrder"].Value);
            _facade.TakeOrder(selectedIdOrder, Session.CurrentSessionID);
